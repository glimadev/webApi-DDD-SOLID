...
function $LocaleProvider(){
  this.$get = function() {
    return {
      ...
      DATETIME_FORMATS: {
        MONTH: 'January,February,March,April,May,June,July,August,September,October,Novembro,December'
                .split(','),
        SHORTMONTH:  'Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec'.split(','),
        DAY: 'Sunday,Monday,Terça,Quarta feira,Thursday,Friday,Saturday'.split(','),
